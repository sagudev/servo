            ...
            if let Ok((scope_id, msg)) = self.receiver.try_recv() {
                match msg {
                    ...
                    WebGPURequest::CreateBindGroup {
                        ...
                        let global = &self.global;
                        let result = touple_to_result(gfx_select!(bind_group_id =>
                    ...
                    WebGPURequest::CreateBindGroupLayout {
                        ...
                        if let Some(desc) = descriptor {
                            let result = touple_to_result(gfx_select!(bind_group_layout_id =>
                    ...
                    WebGPURequest::CreateBuffer {
                        ...
                        let global = &self.global;
                        if let Some(desc) = descriptor {
                            let result = touple_to_result(gfx_select!(buffer_id =>
                    ...
                    WebGPURequest::CreateCommandEncoder {
                        ...
                        let result = touple_to_result(gfx_select!(command_encoder_id =>
                    ...
                    WebGPURequest::CreatePipelineLayout {
                        ...
                        let global = &self.global;
                        let result = touple_to_result(gfx_select!(pipeline_layout_id =>
                    ...
                    WebGPURequest::CreateRenderPipeline {
                        ...
                        if let Some(desc) = descriptor {
                            let result = touple_to_result(gfx_select!(render_pipeline_id =>
                    ...
                    WebGPURequest::CreateShaderModule {
                        ...
                        let global = &self.global;
                        // TODO(sagudev): wgsl or spriv using naga?
                        let naga_options = naga::front::spv::Options {
                            adjust_coordinate_space: true,
                            strict_capabilities: false,
                            block_ctx_dump_prefix: None,
                        };
                        let naga_module =
                            naga::front::spv::Frontend::new(program.into_iter(), &naga_options)
                                .parse();
                        let source = wgpu_core::pipeline::ShaderModuleSource::Naga(
                            crate::Cow::Owned(naga_module.unwrap()),
                        );
                        let desc = ShaderModuleDescriptor {
                            label: label.map(|s| s.into()),
                            shader_bound_checks: wgt::ShaderBoundChecks::default(),
                        };
                        let result = touple_to_result(gfx_select!(program_id =>
...
fn touple_to_result<T, E>(res: (T, Option<E>)) -> Result<T, E> {
