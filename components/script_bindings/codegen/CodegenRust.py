...
def MemberCondition(pref, func, exposed, secure):
    ...
    if func:
        return f'Condition::Func(<D as DomHelpers<D>>::{func.replace("::", "_")})'
    if exposed:
...
class CGDefaultToJSONMethod(CGSpecializedMethod):
    ...
    def definition_body(self):
        ...
        form = """
             if !${parentclass}CollectJSONAttributes::<D>(cx, _obj, this, &result) {
                 return false;
             }
             """
        ...
        for d in descriptors:
            ...
            if nonConstMembers or (ctor and not ctor.isHTMLConstructor()) or d.interface.legacyFactoryFunctions:
                ...
                cgthings += [
                    ...
                    CGGeneric(f"pub use {originalBinding}::{ifaceName}_Binding as {ifaceName}_Binding;"),
                ]
