...
/*pub fn global(g: &impl script_bidings::DomGlobal<crate::DomTypeHolder>) -> DomRoot<GlobalScope> {
    g.global()
}*/

/*impl crate::dom::promise::Promise {
    fn global(&self) -> DomRoot<GlobalScope> {
        global(self)
    }
}

impl crate::dom::windowproxy::WindowProxy {
    fn global(&self) -> DomRoot<GlobalScope> {
        global(self)
    }
}*/
